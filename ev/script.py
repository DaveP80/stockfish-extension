    ...
    with engine.analysis(board, limit=limit) as analysis:
        ...
        if len(analysis)>0:
            ...
            if eng_score is not None:
                ...
                if stm==chess.WHITE:
                    response = {"winning_chances": f'{100 * white_winning_chances:0.2f}', "score_rate": f'{100 * white_score_rate:0.2f}' }
                elif stm==chess.BLACK:
                    response = {"winning_chances": f'{100 * black_winning_chances:0.2f}', "score_rate": f'{100 * black_score_rate:0.2f}' }
